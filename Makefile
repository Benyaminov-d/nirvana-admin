# Nirvana Admin - Makefile
# Repository: nirvana-admin

.PHONY: help setup dev build start stop clean install test lint

# Default target
help:
	@echo "Nirvana Admin - Development Commands"
	@echo "===================================="
	@echo "Available targets:"
	@echo "  setup       - Setup development environment"
	@echo "  start-dev   - Start development server with hot reloading (http://localhost:5175)"
...
start-dev:
	@echo "=== Starting Development Admin with Hot Reloading ==="
	@docker compose up -d admin-dev
	@echo "Development server started with hot reloading:"
	@echo "  - nirvana_admin_dev (Vite dev server)"
...
start-prod:
	@echo "=== Starting Production Admin ==="
	@docker compose up -d admin
	@echo "Production server started in nirvana_network:"
	@echo "  - nirvana_admin (Nginx serving static files)"
	@echo ""
	@echo "Access through nginx reverse proxy:"
